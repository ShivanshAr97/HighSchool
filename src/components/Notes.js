    ...
    return (
        <div className='px-12 py-8 text-lg flex border-b shadow'>
            <div className='w-[70%]'>
                ...
                <Link to="/notes"><button className='text-center border bg-blue-400 text-white border-none font-bold py-1 px-4 
            rounded-lg flex mx-auto my-4'>View Notes</button></Link>
            </div>
            <div className='w-[30%] px-10'>
                <img className=' h-60 object-cover rounded-lg' src="https://images.pexels.com/photos/159497/school-notebook-binders-notepad-159497.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
            </div>
        </div>
    )
}
