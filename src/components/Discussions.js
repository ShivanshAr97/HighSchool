...
const Discussions = () => {
    return (
        <div className='mx-12 text-lg'>
            <h1 className='text-[1.75rem] font-medium'>Having Doubts</h1>
        ...
        sapiente.</p>
            <Link to="/discussions"><button className='text-center border bg-blue-400 text-white border-none font-bold py-1 px-4 rounded-lg flex mx-auto my-4'>Begin Discussions</button></Link>
