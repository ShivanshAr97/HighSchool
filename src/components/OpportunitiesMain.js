    ...
    <div className='flex'>
      <div className='w-[60%] mx-12 my-8'>
        ...
        <div>
          ...
          <h1 className='text-2xl font-bold mt-2'>TwiLearn Edutech</h1>
          <h4>Web Development Intern</h4>
          <div className='flex text-center align-middle justify-between my-1 text-sm'>
            <p>Contributed by: Sahil</p>
            <span>80 applicants</span>
          </div>
        ...
        <div>
          ...
          <h1 className='text-2xl font-bold mt-2'>Sago</h1>
          <h4>Software Intern</h4>
          <div className='flex text-center align-middle justify-between my-1 text-sm'>
            <p>Contributed by: Dua</p>
            <span>169 applicants</span>
          </div>
        ...
        <div>
          ...
          <div className='flex text-center align-middle justify-between my-1 text-sm'>
            <p>Contributed by: Pandya</p>
            <span>76 applicants</span>
          </div>
